...
{
    public partial class iPad_Pro : Form
    {
        public iPad_Pro()
        {
            InitializeComponent();
        ...
        private void iPad_Pro_Load(object sender, EventArgs e)
        {
        ...
        {
            Process.Start(@"C:\Users\Asser Ayman\Desktop\P\Updated\Design for Registration and Login - Copy (2)\4K Video Downloader\iPad Pro Review - Is it worth buying.mp4");
