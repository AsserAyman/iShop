...
{
    public partial class iPhone_7 : Form
    {
        public iPhone_7()
        {
            InitializeComponent();
        ...
        {
            Process.Start(@"C:\Users\Asser Ayman\Desktop\P\Updated\Design for Registration and Login - Copy (2)\4K Video Downloader\iPhone 7 Review - One Month Later!.mp4");
