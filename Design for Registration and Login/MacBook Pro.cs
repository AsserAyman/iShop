...
{
    public partial class MacBook_Pro : Form
    {
        public MacBook_Pro()
        {
            InitializeComponent();
        ...
        private void MacBook_Pro_Load(object sender, EventArgs e)
        {
        ...
        {
         Process.Start(@"C:\Users\Asser Ayman\Desktop\P\Updated\Design for Registration and Login - Copy (2)\4K Video Downloader\MacBook Pro 15 (2018) - Beware the Core i9.mp4");         
        }
    }
}
